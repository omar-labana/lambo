        ...
        <div className="text-white text-2xl flex flex-col items center gap-10 mx-20">
            ...
            <div className="flex justify-around">
                <div className="text-3xl flex flex-col gap-10">
                    <p>Country: <span className="dancing-font">{strArea}</span></p>
                    <p>Category: <span className="dancing-font">{strCategory}</span></p>
                </div>
                <img className="w-1/4" src={strMealThumb} alt={strMeal}></img>
            </div>
            <div className="">
            ...
            <p><span className="dancing-font text-4xl">How to preapare: </span>{strInstructions}</p>
        </div>
    )
}
